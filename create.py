...
# ser_id = get_series_id("Death Note")

# new_season = Seasons(number=1,Series_id=ser_id)
# db.session.add(new_season)

ses_id = get_season_id(1,get_series_id("Death Note"))

src1 = "https://drive.google.com/file/d/14e8U6zQAnui2U1Rlsq6zge-K2clD6Ock/preview" 
new_episode = Episode(number=1,name="Rebirth",src=src1 ,Season_id=ses_id)
db.session.add(new_episode)

src2 = "https://drive.google.com/file/d/1hX2P6zEug9H-jrFO-3mo8_PU5P0dtod-/preview" 
new_episode = Episode(number=2,name="Conferntation",src=src2,Season_id=ses_id)
db.session.add(new_episode)
